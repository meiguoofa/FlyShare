---
layout:     post
title:      Python学习-DAY15
subtitle:   Task15-文件与文件系统
date:       2020-08-06
author:     flyshare
...
- `fileObject.tell()`返回文件的当前位置，即**文件指针当前位置**。
...
print(f.write(b'0123456789abcdef'))  # 16 b'0123456789abcdef'
print(f.seek(5))  # 5 f.seek()返回的是指针移动后的位置
print(f.read(1))  # b'5'
print(f.seek(-3, 2))  # 13
print(f.read(1))  # b'd'
```
...
#感觉这个和linux中的似乎也有的seek差不多 seek offset 在首位置  当前位置  末尾位置
